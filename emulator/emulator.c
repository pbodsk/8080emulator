...
//      state->b = state->m;
    ...
    case 0x80: {
      //ADD B
      //use uint16_t for result so we can detect overflow/carry out
      //this gives us a max value of 0xffff
      uint16_t answer = (uint16_t)state->a + (uint16_t)state->b;
      //if result is zero, set zero flag
      /*
        0 = 0x0000 = 0b0000 0000 0000 0000
        0xff = 0b1111 1111
        ...
        meaning, everything else than straight 0 will result in one of the
        bytes being and'ed true
      */
      if((answer & 0xff)==0) {
        state->cc.z = 1;
      } else {
      ...
      //carry flag (cy), is the result > 0xff (max value of uint8_t)
      //yes? set carry flag
      //no? clear carry flag
      if(answer > 0xff) {
        state->cc.cy = 1;
      ...
      //parity is handled by subrutine
      //state-> cc.p = Parity(answer & 0xff);

      //store result in a
      //AND is used to trim
      // 0x02 = 0b0000 0010 AND
      //        0b1111 1111
      //        -----------
      //        0b0000 0010
      state->a = answer & 0xff;
    ...
    case 0xc9:
      //RET
      //Set pc to value from stack (OR'ed together, low endian)
      state->pc = state->memory[state->sp] | (state->memory[state->sp+1] << 8);
      state->sp += 2;
      break;
    case 0xca: //JZ Addr
...
static int Disassemble8080Op(unsigned char* codebuffer, int pc) {
    ...
    switch (*code) {
        ...
        case 0x03: printf("INC      B"); break;
        case 0x04: printf("INR      B"); break;
        case 0x05: printf("DCR      B"); break;
        case 0x06: printf("MVI      B,#$%02x", code[1]); opbytes=2; break;
        case 0x07: printf("RLC"); break;
        case 0x08: printf("not implemented"); break;
        ...
        case 0x10: printf("not implemented"); break;
        ...
        case 0x18: printf("not implemented"); break;
        ...
        case 0x28: printf("not implemented"); break;
        ...
        case 0x31: printf("LXI      SP,#$%02x%02x", code[2], code[1]); opbytes=2; break;
        ...
        case 0x38: printf("not implemented"); break;
        case 0x39: printf("DAD      SP"); break;
        case 0x3a: printf("LDA      #$%02x%02x", code[2], code[1]); opbytes=3; break;
        case 0x3b: printf("DCX      SP"); break;
        case 0x3c: printf("INR      A"); break;
        case 0x3d: printf("DCR"); break;
        ...
        case 0x75: printf("MOV      H,L"); break;
        ...
        case 0xcb: printf("not implemented"); break;
        ...
        case 0xd9: printf("not implemented"); break;
        case 0xda: printf("JC       #$%02x%02x", code[2], code[1]); opbytes=3; break;
        case 0xdb: printf("IN       #$%02x", code[1]); opbytes=2; break;
        case 0xdc: printf("CC       #$%02x%02x", code[2], code[1]); opbytes=3; break;
        case 0xdd: printf("not implemented"); break;
        ...
        case 0xed: printf("not implemented"); break;
        ...
        case 0xf7: printf("RST      4"); break;
        case 0xf8: printf("RM"); break;
        case 0xf9: printf("SPHL"); break;
        case 0xfa: printf("JM       #$%02x%02x", code[2], code[1]); opbytes=3; break;
        case 0xfb: printf("EI"); break;
        case 0xfc: printf("CM       #$%02x%02x", code[2], code[1]); opbytes=3; break;
        case 0xfd: printf("not implemented"); break;
        case 0xfe: printf("CPI      #$%02x", code[1]); opbytes=2; break;
        case 0xff: printf("RST      7"); break;

        default: printf("--> 0x%02x", code[0]);
    }
